...
/* KML layer not working because of offset

  new google.maps.KmlLayer({
    url: "https://lilanyang.studio/kml/paris-texas-live.kmz",
    map: map,
  });
*/
}
...
function getDirections1(map) {
  ...
  var request = {
    ...
    waypoints: 'Terlingua, TX', // Terlingua
...
function getDirections2(map) {
  ...
  var request = {
    ...
    waypoints: [{
        location: '51470 TX-118, Alpine, TX 79830'
      }, // Terlingua M.D. Clinc
      {
        location: '701 US-90, Marathon, TX 79842'
      }, // Marathon Motel & RV Park
      {
        location: 'NE 1st Street, Marathon, TX 79842'
      }, // Shoemaker Hardware Store
      {
        location: '901 E Dickinson Blvd, Fort Stockton, TX 79735'
      }, // El Rancho Motel
      {
        location: '609 E Dickinson Blvd, Fort Stockton, TX 79735'
      }, // Stop at the Gas Station
      {
        location: '6701 Convair Rd, El Paso, TX 79925'
      }, // El Paso Airport
      {
        location: '6505 Convair Rd Suite 400, El Paso, TX 79925'
      }, // Avid Car Rental
      //{location: new google.maps.LatLng(35.111173, -115.542870)}      // Mojave Desert
    ],
    destination: '10060 Olivia Terrace, Sun Valley, CA 91352', // Walter's Home
...
function getDirections3(map) {
  ...
  var request = {
    ...
    waypoints: [{
        location: new google.maps.LatLng(34.219730, -118.350115)
      }, // Backyard
      {
        location: new google.maps.LatLng(34.198446, -118.321350)
      }, // Hunter's School
      {
        location: new google.maps.LatLng(34.219878, -118.350022)
      }, // Walter's Home
      {
        location: new google.maps.LatLng(34.198446, -118.321350)
      }, // Hunter's School
      {
        location: new google.maps.LatLng(34.220059, -118.348308)
      }, // Walking home midpoint
      {
        location: new google.maps.LatLng(34.219878, -118.350022)
      }, // Walter's home
      {
      ...
      {
        location: '13795 Balboa Blvd, Sylmar, CA 91342'
      } // Travis Nightwalking
    ],
...
function getDirections5(map) {
  ...
  var request = {
    ...
    waypoints: [{
        location: new google.maps.LatLng(29.764011, -95.362674)
      }, // Chase Bank Drive Up
      {
        location: new google.maps.LatLng(29.871551, -93.934962)
      }, // Port Auther
      {
        location: new google.maps.LatLng(29.871065, -93.934972)
      } // Travis enters building
    ],
...
function getDirections6(map) {
  ...
  var request = {
    ...
    waypoints: [{
        location: new google.maps.LatLng(28.921138, -97.609307)
      }, // Westhoff ??? Nordheim
      {
        location: new google.maps.LatLng(28.921919, -97.610754)
      }, // Broadway Bar
      {
        location: new google.maps.LatLng(28.922325, -97.610163)
      }, // Grocery
      {
        location: new google.maps.LatLng(29.757957, -95.371180)
